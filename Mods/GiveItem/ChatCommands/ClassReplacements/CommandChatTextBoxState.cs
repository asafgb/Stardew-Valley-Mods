...
namespace ChatCommands.ClassReplacements
{
    internal class CommandChatTextBoxState
    {
        ...
        public CommandChatTextBoxState(int currentInsertPosition, int currentSnippetIndex, long currentRecipientId, string currentRecipientName, IEnumerable<ChatSnippet> finalText)
        {
